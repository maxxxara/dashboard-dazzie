  ...
  return (
    <div className='w-2/3 mt-10 flex flex-col gap-4'>
        <div className='flex flex-col'>
            <span className='font-medium ml-2 mb-1 text-sm'>Name</span>
            <div>
                <input type="text" className='w-full rounded-lg border-2 border-blue px-4 py-4 text-icons text-sm' placeholder='input new user name here'/>
            </div>
        </div>
        <div className='flex flex-col'>
        ...
        <div className='flex flex-col'>
            <span className='font-medium ml-2 mb-1 text-sm'>Token</span>
            <div className='flex items-center relative'>
                <input type="text" className='w-full rounded-lg border-2 border-blue px-4 py-4 text-icons text-sm' placeholder='input company token here'/>
                <FiEye className='absolute w-5 h-5 right-4 text-icon cursor-pointer'/>
            </div>
        </div>
        <div className='flex items-center'>
            ...
            <p className='text-xs font-thin text-icon ml-3'>I have read and agree to the Terms of Service</p>
        </div>
        <button className='bg-blue text-white font-medium text-sm py-4 rounded-lg mt-4'>Sign Up</button>
        <button className='border-2 borderblue text-blue font-medium text-sm py-4 rounded-lg'>Sign Up With QR Code</button>
    </div>
  )
}
